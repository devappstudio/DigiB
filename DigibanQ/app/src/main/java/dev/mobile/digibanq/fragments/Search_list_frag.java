...
import dev.mobile.digibanq.adapter.ContactsAdapter;
import dev.mobile.digibanq.adapter.SearchAdapter;
import info.androidhive.digibanq.R;

/**
 * Created by banktech on 9/22/2016.
 */
public class Search_list_frag extends Fragment {

    private static final String TAG = "Search_list_frag";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.search_list_frag, container, false);
        rootView.setTag(TAG);
